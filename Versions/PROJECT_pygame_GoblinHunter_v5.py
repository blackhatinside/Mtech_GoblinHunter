	...
	while run and score != 100:
		...
		if goblin and goblin.visible == True:
			...
			goblin = Enemy(
				...
				width = 64,
				height = 64,
				end = random.randint(1, 4) * 100,
				velocity = random.randint(1, 8 if score else 4),
